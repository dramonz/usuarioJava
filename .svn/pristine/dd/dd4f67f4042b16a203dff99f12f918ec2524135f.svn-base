...
<head>
	...
	<title>Asignar Rol al Usuario</title>
...
<body>
	<div class="module-title">
		...
		<h1>Usuarios &gt; Asignar Rol al Usuario</h1>
	</div>
	<div id="form-agregar-usuario"></div>
	<div id="grid-rol-usuario"></div>
	...
	<script type="text/javascript" src="<c:url value="/app/modules/usuario/asignarRolUsuario.js" />"></script>
</body>
</html>