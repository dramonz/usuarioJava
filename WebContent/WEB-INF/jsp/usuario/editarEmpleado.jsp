...
<body>
	<div class="module-title">
		...
		<h1>Usuarios &gt; Editar Empleado</h1>
	</div>
	<div id="form-agregar-empleado" class="module-widget"></div>
	<div id="grid-editar-empleado" class="module-widget"></div>
	...
	<script type="text/javascript" src="<c:url value="/app/modules/usuario/editarEmpleado.js" />"></script>
</body>
</html>