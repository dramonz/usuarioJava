...
<body>
	<div class="module-title">
		...
		<h1>Usuarios &gt; Agregar Empleado</h1>
	</div>
	<div id="form-agregar-empleado"></div>
	...
	<script type="text/javascript" src="<c:url value="/app/modules/usuario/agregarempleado.js" />"></script>
</body>
</html>