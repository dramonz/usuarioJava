...
<head>
	...
	<title>Agregar Proyectos Que No Puede Ver</title>
...
<body>
	...
	<div class="module-title">
		...
		<h1 id="module-title">Usuarios > Agregar Proyectos Que No Puede Ver</h1>
	</div>
	
	<div id="form-buscar" class="form-buscar-proyectos"></div>
	
	<div id="grid-buscar" class="grid-buscar-proyectos"></div>
	...
	<script type="text/javascript" src="<c:url value="/app/modules/usuario/agregarProyecto.js" />"></script>
