...
<body>
	<div class="module-title">
		...
		<h1>Usuarios &gt; Editar Rol</h1>
	</div>
	
	<div id="form-agregar-rol" class="module-widget"></div>
	<div id="form-grid-modulo" class="module-widget"></div>
	<div id="grid-editar-rol" class="module-widget"></div>
	...
	<script type="text/javascript" src="<c:url value="/app/modules/usuario/editarRol.js" />"></script>
</body>
</html>