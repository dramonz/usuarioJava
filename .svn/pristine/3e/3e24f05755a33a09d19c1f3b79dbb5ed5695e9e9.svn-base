...
<body>
	<div class="module-title">
		...
		<h1>Usuarios &gt; Editar Usuario</h1>
	</div>
	<div id="form-editar-usuario" class="module-widget"></div>
	<div id="grid-editar-usuario" class="module-widget"></div>
	...
	<script type="text/javascript" src="<c:url value="/app/modules/usuario/editarUsuario.js" />"></script>
</body>
</html>