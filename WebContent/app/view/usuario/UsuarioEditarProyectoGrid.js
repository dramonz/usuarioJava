Ext.define('PR.view.usuario.UsuarioEditarProyectoGrid', {
	extend:'Ext.grid.Panel',
	alias:'widget.usuarioProyectoGrid',
	store:'UsuariosProyectosPerteneceGrid',
	...
	initComponent: function() {
		this.columns=[
		 ...
		 this.dockedItems= [{
				...
				dock: 'bottom',
				items: [{
					id:'id-Eliminar-Proyectos',
	        		text:Messages.btn.eliminarProyectosUsuarios,
