...
//		this.getStore('PermisosRolTree').addListener('load', this.onLoadPermisos, this);
//		
	...
	eliminarPermisosRol: function(btn) {
		...
		Ext.Msg.show({
			title : 'Advertencia',
			msg: '¿Esta seguro que desea eliminar permisos del rol?',
			...
			fn : function(boton){
				if (boton == 'yes'){
					...
					success: function(response){
						...
						_this.getStore('PermisosRolTree').load({
							params: {
								rol: Ext.getCmp('nombreRol').getValue()
							},
							callback : function(result){
								_this.getStore('PermisosTree').load({
									params: {
										rol: Ext.getCmp('nombreRol').getValue()
									}
//								,
...
//						Ext.getCmp('rolusuariotree').getForm().reset();
...
//		Ext.getCmp('permisotree').getForm().reset();
//		this.getStore('PermisosRolTree').load({
//			params: {
//				rol: Ext.getCmp('nombreRol').getValue()
//			},
//			callback : function(response){
//				//aqui pueden manejar la respuesta del grid y con eso limpiarlo o revisar o no se
//				
//			}
//		
//		});
